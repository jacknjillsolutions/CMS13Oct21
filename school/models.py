...
class extendeduser(models.Model):    
    ...
    def save(self, *args, **kwargs):
       ...
       # )
        ...
        #body="Your OTP is "+str(otp),
       #)
        #Jahnavi Mobile - +91 766 00 928 29
        otp=random.randint(100000,999999)
        account_sid = 'ACef9840a1c1fbef0c4448090f285847db'
        auth_token = '1be67126e95ff4e9b653c8abd5d9e187'
        client = Client(account_sid, auth_token)
        message=client.messages.create(
        to=self.mobileno,
        from_="+13309698650",
...
class Sendsms(models.Model):       
    ...
    def save(self, *args, **kwargs):
       ...
       #)
        ...
        # Tula's
        #otp=random.randint(100000,999999)
        account_sid = 'AC763dfe44a6fbd39a50e52f9170512853'
        auth_token = '9e5422df981746094e754e105a9666aa'
        client = Client(account_sid, auth_token)
        message=client.messages.create(
        to=self.mobileno,
        from_="+16418602091",
...
class PayDetailsExcelupload(models.Model):
    branch =  models.CharField(max_length=255, null=True, blank=True)
    date = models.DateField(null=True,blank=True)
    Shift = models.CharField(max_length=255,null=True)
    CenterCode = models.CharField(max_length=255, null=True, blank=True)
    ...
    PayAmt = models.FloatField(default=0.00,null=True, blank=True)
...
class Daily_data(models.Model):
   ...
   # active = models.BooleanField(default=True)
    ...
    def __str__(self):
        return self. centercode
## Sales module 
## Models - daily_sales , prodMaster, Customer,SalesExec,Zone,custType,Coupon,daily_receipts,recType
#Daily_sales - centercode
class daily_sales(models.Model):
    branch =  models.CharField(max_length=255, null=True, blank=True)    
    custcode = models.CharField(max_length=255, null=True, blank=True)#Customer.custCode-custName
    date = models.DateField(null=True,blank=True)
    shift = models.CharField(max_length=255,null=True,blank=True)
    orderNo =  models.IntegerField(default=0)   
    custType = models.CharField(max_length=15, null=True, blank=True)#custType.cTypeCode-cTypeName
    prodCode  = models.CharField(max_length=25,null=True,blank=True)#prodMaster.PCode-PName
    quantity = models.FloatField(default=0.00,null=True, blank=True)#float Keyin
    couponCode  = models.CharField(max_length=25,null=True,blank=True)#Coupon.cpCode-cpName
    disc = models.FloatField(default=0.00,null=True, blank=True)    
    comm  = models.FloatField(default=0.00,null=True, blank=True)    
    amount  = models.FloatField(default=0.00,null=True, blank=True)
    unitRate  = models.FloatField(default=0.00,null=True, blank=True)#prodMaster.UnitRate   
    netAmount  = models.FloatField(default=0.00,null=True, blank=True)#QTY*unitRate by ProdMaster.PCode 
    ZoneCode =  models.CharField(max_length=255, null=True, blank=True)#Zone.zCode-zName
    SaleExecCode =  models.CharField(max_length=255, null=True, blank=True)#SalesExec.SEcode
    remove = models.CharField(max_length=255,null=True,blank=True)
    remarks = models.CharField(max_length=25,null=True,blank=True)#key-in/Cash
    upt_by = models.ForeignKey(User, on_delete=models.DO_NOTHING, blank=True, null=True, related_name='updSale')
    created_by = models.ForeignKey(User, on_delete=models.DO_NOTHING, blank=True, null=True, related_name='createSale')
    updatedd = models.DateTimeField(default=timezone.now)
    crreatedd = models.DateTimeField(default=timezone.now)
    #sour = models.CharField(max_length=255, null=True, blank=True)
   # active = models.BooleanField(default=True)
...
class prodMaster(models.Model):
    PCode = models.CharField(max_length=25,null=True,blank=True)
    PName = models.CharField(max_length=50,null=True,blank=True)
    document = models.FileField(upload_to='prodimage',null=True,blank=True)
    custCode = models.CharField(max_length=255,null=True,blank=True)
    PStDate  = models.DateField(null=True,blank=True)
    PEndDate = models.DateField(null=True,blank=True)
    unitRate = models.FloatField(default=0.0,null=True,blank=True)    
...
class Coupon(models.Model):
    cpCode = models.CharField(max_length=25,null=True,blank=True)
    cpName = models.CharField(max_length=50,null=True,blank=True)
    PStDate  = models.DateField(null=True,blank=True)
    PEndDate = models.DateField(null=True,blank=True)
    CoupValue = models.FloatField(default=0.0,null=True,blank=True)    
    PCode = models.CharField(max_length=255, null=True, blank=True)
...
class daily_receipts(models.Model):
    branch =  models.CharField(max_length=255, null=True, blank=True)    
    orderNo =  models.IntegerField(default=0)#daily_sales.orderNo-custcode
    ...
    payRefNo  = models.CharField(max_length=25,null=True,blank=True)#key-in/Cash/Chqno/internetbankingrefcode    
    amount  = models.FloatField(default=0.00,null=True, blank=True)    
    remarks = models.CharField(max_length=25,null=True,blank=True)#key-in/Cash
    remove = models.CharField(max_length=255,null=True,blank=True)
...
class Customer(models.Model):
    branch=models.CharField(max_length=255,null=True,blank=True)
    custCode = models.CharField(unique = True,max_length=255)
    custName = models.CharField(max_length=255)
    cust_type = models.CharField(max_length=255,null=True,blank=True)#custType.cTypeCode
    zoneCode = models.CharField(max_length=255,null=True,blank=True)
    saleExecCode = models.CharField(max_length=255,null=True,blank=True)    
    #route_number  = models.IntegerField(null=True,blank=True)
    #
    ...
    email = models.CharField(max_length=225,null=True,blank=True)
    address =  models.TextField(null=True,blank=True)
    document = models.FileField(upload_to='custimage',null=True,blank=True)
    

    #bankacctno = models.CharField(max_length=255,null=True,blank=True)
    #acctholdername = models.CharField(max_length=255,null=True,blank=True)
    #ifsc=models.CharField(max_length=255,null=True,blank=True)    
    #bankName = models.CharField(max_length=255,null=True,blank=True)
    #bankBranch = models.CharField(max_length=255,null=True,blank=True)
    distance = models.IntegerField(null=True,blank=True)
...
class SalesExec(models.Model):
    ...
    SEJoinDate = models.DateField(null=True,blank=True)
    SELastDate = models.DateField(null=True,blank=True)
...
class Zone(models.Model):
    zCode = models.CharField(unique = True,max_length=255)
    zName = models.CharField(max_length=255)
    zSt_date = models.DateField(null=True,blank=True)
    zEnd_date = models.DateField(null=True,blank=True)
    active = models.BooleanField(default=True) 
    remove = models.CharField(max_length=255,null=True,blank=True)

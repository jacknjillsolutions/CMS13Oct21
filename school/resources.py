...
from school.models import Excelupload,dailydataExcelupload,PayDetailsExcelupload,tsratesexcelupload,Centermasterdataexcelupload,Ifscexcelupload,ExtractEMSData,ExtractPlantData,Proc_Data_EE
...
class PayDetailsExceluploadReource(resources.ModelResource):
    class meta: 
        model = PayDetailsExcelupload
